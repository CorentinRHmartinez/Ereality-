...
<head>
	...
	<link href="css/coming-sssoon-re.css" rel="stylesheet" />    
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav navbar-right">
            <li>
             ...
             <li>
                <a href="https://twitter.com/eRealityTechno"> 
                    <i class="fa fa-twitter"></i>
                    Twitter
                </a>
            </li>
             <li>
                <a href="mailto:contact@e-reality.fr"> 
...
<!--  H1 can have 2 designs: "logo" and "logo cursive"           -->
        ...
        <div class="content">
            <h4 class="motto">Merci pour votre message </h4>
<div class="center">
<a href="www.e-reality.fr" class="button">Retour au site</a>
	</div>
   ...
   <script src="jss/jquery-1.10.2.js" type="text/javascript"></script>
